...
(function () {
  ...
  const I18N = {
    zh: {
      ...
      'meta.desc': '宋京（Joss.Song）—— 通识科技创始人兼CEO，宋京工作室Boss，简道奠基人。创业者，投资人，懂点技术，偶尔写作，喜欢喝茶or咖啡，广交好友。',
      'hero.hint': '关于我 · about',
      ...
      'intro.back': '返回首页',
      'intro.topAria': '回到顶部',
      'intro.hi': '通识科技CEO · 宋京工作室Boss · 简道奠基人',
      'intro.nameZh': '宋京',
      ...
      'tl.7.title': '创办宋京公益基金会', 'tl.7.desc': '同年 9 月出书《简道》。',
    ...
    en: {
      ...
      'meta.desc': "Joss.Song — Founder of Joss's Studio & CEO of Tongshi Group, Enlightenment of Jiandao. Entrepreneur, investor, tech-savvy, occasional writer, tea lover, and a friend to all.",
      'hero.hint': 'Tap me · About',
      'hero.brandMark': "Joss's Studio",
      'hero.signature': 'Reach for the stars · Stand on the ground',
      'hero.characterAria': "Open Joss Song's profile",
      'intro.backAria': 'Back to home',
      'intro.back': 'Back to Home',
      'intro.topAria': 'Back to top',
      'intro.hi': 'CEO of Tongshi Group · Boss of Joss"s Studio · Founder of Jiandao',
      ...
      'intro.secWorks': 'Portfolio demo',
      'intro.secProjects': 'Projects',
      'intro.secBlog': 'Blog',
      'intro.blogFallback': 'If the frame is blocked, open in Notion ↗',
      ...
      'work.1.title': 'Jian Dao ', 'work.1.sub': 'The foundational work of Jiandao',
      'work.2.title': 'Yuan Yu Ji ', 'work.2.sub': 'Essays on the metaverse',
      ...
      'tl.7.title': 'Founded the Song Jing Foundation', 'tl.7.desc': 'Published the book Jian Dao in September of that year.',
